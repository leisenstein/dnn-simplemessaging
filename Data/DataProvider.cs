...
namespace PMCC.Modules.CITMessages.Data
{
    ...
    public abstract class DataProvider
    {
        ...
        public static DataProvider Instance()
        {
            if (provider == null)
            {
                const string assembly = "PMCC.Modules.CITMessages.Data.SqlDataprovider,CITMessages";
        ...
        public abstract IDataReader GetActiveUsers();
        public abstract IDataReader GetActiveCategories();
        public abstract int AddMessage(Message m);
        public abstract int DeleteMessage(Message m);
        public abstract int UpdateMessage(Message m);
        public abstract DataTable GetMessages(int userID, int iNumOfViews);
        public abstract DataTable GetMessagesForEditor(int userID);
